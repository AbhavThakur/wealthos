...
function buildHistory() {
  ...
  for (let i = -5; i <= 0; i++) {
    ...
    history.push({
      ...
      p1Income: 125000 + 15000,
      p1Expenses: 55000 + Math.round(offset * 800),
      p1Investments: 37500,
      p2Income: 95000,
      p2Expenses: 26500 + Math.round(offset * 500),
      p2Investments: 17500,
      sharedTripExpenses: 0,
      p1NetWorth: 1200000 + offset * 85000,
      p2NetWorth: 750000 + offset * 55000,
    });
  }
  return history;
}
